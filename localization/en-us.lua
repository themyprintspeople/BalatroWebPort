    ...
    descriptions={
        ...
        Joker={
            ...
            j_chudjoker={
                name="Chudjoker",
                text={
                    "All {C:attention}listed {C:green,E:1,S:1.1}probabilities{} will",
                    "no longer have a chance",
                    "of occuring.",
                    "{C:inactive,s:0.7}because Nothing. Ever. Happens.",
                },
            },
            j_minim_free_refill={
                name="Free Refill",
                text={
                    "This Joker gains {X:mult,C:white} X#1# {} Mult",
                    "when a {V:1}#2#{} card is destroyed,",
                    "suit changes every round",
