...
function Card:set_sprites(_center, _front)
    ...
    if _center then
		...
		local atlas_key = (back_ref and (back_ref[G.SETTINGS.colourblind_option and 'hc_atlas' or 'lc_atlas'] or back_ref.atlas)) or 'centers'
		self.children.back = SMODS.create_sprite(self.T.x, self.T.y, self.T.w, self.T.h, atlas_key, self.params.bypass_back or ((back_ref and back_ref.pos) or G.P_CENTERS['b_red'].pos))
